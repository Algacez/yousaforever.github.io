if(1) {
    fetch('http://52.184.81.18:13482/api/v1/memo?creatorId=1&tag=%E8%AF%B4%E8%AF%B4&limit=30').then(res => res.json()).then(data => { //修改为你的memos地址
        let items = [],
            html = '',
        ...
        items.forEach(item => {
            ...
            <div class="talk_item">
                <div class="talk_meta">
                    <img class="nolazyload avatar" src="https://pic.imgdb.cn/item/64e42d1b661c6c8e54a18cd7.png"> 
                    <div class="info">
